...
tree.setup {
  ...
  ignore_ft_on_setup = {},
  -- closes neovim automatically when the tree is the last **WINDOW** in
  -- the view
  auto_close = false,
  ...
  update_focused_file = {
    ...
    -- `update_focused_file.update_cwd` is true and `update_focused_file.enable`
    -- is true
    ignore_list = {}
  },
  ...
  view = {
    ...
    width = 30,
    -- height of the window, can be either a number (columns) or a string in
    -- `%`, for top or bottom side placement
    height = 30,
