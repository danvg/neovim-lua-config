...
map("n", "<leader>fa",  "<cmd>lua require('plug_config.telescope_utils').search_dotfiles()<CR>")
map("n", "<leader>fn",  "<cmd>lua require('plug_config.telescope_utils').search_nvim_config()<CR>")
